...
const Header = () => {
    ...
    return (
        <header className="max-[767px]:h-10vh h-13vh">
            <div className='h-full md:h-32 flex flex-row items-center relative justify-between  md:pb-9 xl:pb-0 xl:pt-9 '>
                <div className='hidden xl:block absolute w-4/12 h-px left-[10%] bg-[#616476] z-10'></div>
                ...
                <nav className={`${!toggleMenu ? "hidden" : ""} max-[767px]:fixed max-[767px]:inset-y-0 max-[767px]:right-0 md:flex justify-center items-center h-full w-3/5 backdrop-blur-[10px] bg-transparent-gray`}>
                    <div className={`${!toggleMenu ? "hidden" : "min-[768px]:hidden"} max-[767px]:h-10vh max-[767px]:w-90of100 flex justify-end items-center`}>
