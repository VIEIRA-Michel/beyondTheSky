    ...
    return (
        <header className="">
            <div className='h-full md:h-32 flex flex-row items-center relative justify-between  md:pb-9 xl:pb-0 xl:pt-9 '>
                ...
                <nav className={`${!toggleMenu ? "hidden" : ""} max-[767px]:fixed max-[767px]:inset-y-0 max-[767px]:right-0 md:flex justify-center items-center h-full w-3/5`} style={backgroundNavbar}>
